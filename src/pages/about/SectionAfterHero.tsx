const SectionAfterHero = () => {
    return (
        <div className="flex lg:flex-row flex-col my-5 items-center gap-5 mt-32">
            <div className="section-after-hero-a text-white flex flex-col justify-center lg:px-10 px-3">
            ...
            <div className="section-after-hero-b text-white flex flex-col justify-center lg:px-10 px-3">
                <div className="flex flex-col gap-5 lg:mt-80 md:mt-40 pb-2 mt-20">
                    <div>
